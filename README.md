...
6. Next, we will perform alignment of the two slices. We will use 15 automatically selected genes (the more the better, but it is also slower), a maximum error of 100 and require at least 30 inliers per gene (this dataset is more robust than the SlideSeq one).
```bash
