...
@Command(name = "st-align-pairs-add", mixinStandardHelpOptions = true, version = "0.2.0", description = "Spatial Transcriptomics as IMages project - add manual landmarks to align pairs of slices")
