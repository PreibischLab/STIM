...
public class STDataOld extends STDataMinimal implements EuclideanSpace
{
	public SimpleStats distanceStats;
	public RealInterval interval;
	public Interval renderInterval;

	public STDataOld( final List< double[] > coordinates, final HashMap< String, double[] > genes )
	{
	...
	public STDataOld( final STDataMinimal stdata )
	{
