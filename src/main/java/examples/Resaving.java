...
public class Resaving
{
	protected static void resaveNormalizedSlideSeq() throws IOException, InterruptedException, ExecutionException
	{
		...
		final SpatialDataContainer container = SpatialDataContainer.openExisting(path + "slide-seq.n5");
		...
		for ( final String puck : pucks ) {
			...
			final SpatialDataIO sdout = SpatialDataIO.inferFromName(puck + "-normalized.n5");
	...
	protected static void resaveSlideSeq() throws IOException, InterruptedException, ExecutionException
	{
		...
		final SpatialDataContainer container = SpatialDataContainer.createNew(path + "slide-seq.n5");
		...
		for ( final String puck : pucks ) {
			...
			SpatialDataIO sdout = SpatialDataIO.inferFromName(puck + ".n5");
