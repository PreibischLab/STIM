...
{
	public static STDataN5 saveAndOpenSTDataN5( final STData dataIn, final String n5path ) throws IOException, InterruptedException, ExecutionException
	{
		return saveSTDataN5( dataIn, n5path, true );
	}

	public static void saveSTDataN5( final STData dataIn, final String n5path ) throws IOException, InterruptedException, ExecutionException
	{
		saveSTDataN5( dataIn, n5path, false );
	}

	protected static STDataN5 saveSTDataN5( final STData dataIn, final String n5path, final boolean open ) throws IOException, InterruptedException, ExecutionException
	{
		final File n5pathFile = new File( n5path );

		N5IO.writeN5( dataIn, n5pathFile );

		if ( open )
			return N5IO.readN5( n5pathFile );
		else
			return null;
	}
